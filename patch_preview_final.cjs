...
const startIndex = code.indexOf('const VideoPreview = React.memo');
const endIndex = code.indexOf('interface VideoCardProps');
...
code = code.substring(0, startIndex) + newVideoPreview + code.substring(endIndex);
