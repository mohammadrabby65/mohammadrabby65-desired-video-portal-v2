              ...
              <tbody className="divide-y divide-neutral-800/50">
                {history.map((record) => (
                  ...
                  >
                    <td className="px-4 py-3 text-neutral-400">
                      {record.checkedAt?.toDate
                        ? record.checkedAt.toDate().toLocaleString()
                        : "Just now"}
                    </td>
                          ...
                          <img
                            ...
                            onError={(e) => {
                              ...
                              (e.target as HTMLImageElement).className =
                                "w-full h-full object-contain p-2 opacity-30";
                            }}
                          />
                        ) : (
                ...
                {history.length === 0 && !loading && (
                  <tr>
                    ...
                    >
                      No history records found. Run the scanner to generate
                      history.
                    </td>
                  </tr>
                )}
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 w-full max-w-lg space-y-4">
            ...
            <div className="flex flex-col gap-1 mb-4">
              ...
              <p className="text-neutral-400 text-sm">
                ...
                <span className="capitalize">{editingRecord.status}</span>
              </p>
            </div>
