...
export function DMCA() {
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-16 min-h-screen">
      <SEO
        title="DMCA Policy - Desired"
        description="DMCA Notice and Takedown Policy for DESIRED."
        exactTitle={true}
      />
      <div className="prose prose-invert max-w-none prose-headings:text-white prose-p:text-neutral-300 prose-a:text-red-500 hover:prose-a:text-red-400">
        ...
        <p>
          DESIRED respects the intellectual property rights of others and complies with the Notice and Takedown provisions of the Digital Millennium Copyright Act ("DMCA"), 17 U.S.C. § 512.
        </p>
        <p>
          DESIRED qualifies as a "Service Provider" under the DMCA and is entitled to the protections provided under the DMCA safe harbor provisions. We are committed to responding promptly to valid copyright infringement notices and taking appropriate action where necessary.
        </p>
        <p>
          By using DESIRED, you acknowledge and agree to the terms of this DMCA Policy.
        </p>
        ...
        <p>
          If you believe that any material available on DESIRED infringes your copyright, please send a written notification containing the following information:
        </p>
        ...
        <ul className="list-none space-y-4 my-6 p-0">
          ...
          <li><strong>(c)</strong> Identification of the material that is claimed to be infringing, including sufficient information to permit us to locate the material on DESIRED.</li>
