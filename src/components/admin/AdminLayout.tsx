...
import { LayoutDashboard, FileVideo, ListVideo, FolderKanban, BarChart3, Settings, LogOut, Menu, UserCircle, Link as LinkIcon, Radio } from 'lucide-react';
...
const MENU_ITEMS = [
  ...
  { icon: Radio, label: 'Monetization', path: '/admin/monetization' },
