...
export const PromoWidget = memo(function PromoWidget() {
  ...
  useEffect(() => {
    ...
    script.src =
      "https://predestineheadypleasure.com/6f198c1242ec9b64cc7ae9a88d475083/invoke.js";
  ...
  return (
    <div className="w-full col-span-full flex justify-center items-center my-4 overflow-hidden min-h-[100px] bg-neutral-900/40 rounded-2xl border border-neutral-800/50">
      <div
        id="container-6f198c1242ec9b64cc7ae9a88d475083"
        ref={containerRef}
      ></div>
    </div>
  );
